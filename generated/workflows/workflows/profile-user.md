...
Key references:
- @generated/workflows/references/ui-brand.md (display patterns)
- @$HOME/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @generated/workflows/references/user-profiling.md (profiling reference doc)
</required_reading>
...
- The user-profiling reference doc at `generated/workflows/references/user-profiling.md`
