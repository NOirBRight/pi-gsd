...
<required_reading>
@generated/workflows/references/user-story-template.md
@generated/workflows/references/spidr-splitting.md
@generated/workflows/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@generated/workflows/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@generated/workflows/references/user-story-template.md`:
...
Run the SPIDR rules from `@generated/workflows/references/spidr-splitting.md`. Briefly:
