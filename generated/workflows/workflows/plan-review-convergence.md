...
Execute: Invoke /gsd-plan-phase {PHASE} {GSD_WS} in Pi
...
Execute: Invoke /gsd-review --phase {PHASE} {REVIEWER_FLAGS} {GSD_WS} in Pi
...
Execute: Invoke /gsd-plan-phase {PHASE} --reviews --skip-research {GSD_WS} in Pi
...
- [ ] Initial planning via Agent → Invoke /gsd-plan-phase in Pi if no plans exist
- [ ] Review via Agent → Invoke /gsd-review in Pi — isolated, not inline; {GSD_WS} forwarded
- [ ] Replan via Agent → Invoke /gsd-plan-phase --reviews in Pi — isolated, not inline
