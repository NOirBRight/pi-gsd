...
Reference full template: `__PI_GSD_OFFICIAL_ROOT__/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `__PI_GSD_OFFICIAL_ROOT__/get-shit-done/templates/state.md`.
