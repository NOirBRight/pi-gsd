...
> Pi adapter note: unsupported official tools omitted: WebSearch
...
<required_reading>
@__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  ...
                  → writes to __PI_GSD_OFFICIAL_ROOT__/get-shit-done/hooks/
...
@__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/thinking-models-debug.md
...
- Read @__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/common-bug-patterns.md
