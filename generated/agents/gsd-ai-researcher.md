...
> Pi adapter note: unsupported official tools omitted: WebFetch, WebSearch, mcp__context7__*
...
<required_reading>
Read `__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
