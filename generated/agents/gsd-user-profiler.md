...
<reference>
@__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/user-profiling.md` to load:
