...
> Pi adapter note: unsupported official tools omitted: WebSearch, WebFetch, mcp__context7__*
...
<required_reading>
Read `__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
