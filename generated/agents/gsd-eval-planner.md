...
> Pi adapter note: unsupported official tools omitted: AskUserQuestion
...
<required_reading>
Read `__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/ai-evals.md` before planning. This is your evaluation framework.
</required_reading>
