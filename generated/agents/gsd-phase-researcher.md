...
> Pi adapter note: unsupported official tools omitted: WebSearch, WebFetch, mcp__context7__*, mcp__firecrawl__*, mcp__exa__*
...
@__PI_GSD_OFFICIAL_ROOT__/get-shit-done/references/thinking-models-research.md
...
```bash
node "__PI_GSD_OFFICIAL_ROOT__/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
